 ...
 ****<span style="color:red; font-size:18px;">Please stop the IDM to view the generated PDF INFO.</span>****<br/>(To stop download using IDM use  **idm->options->General->untick the browser you are using**)
		<fieldset>
